...
#pretrain_path = "./checkpoints/climate/interm_epoch_9.ckpt"
#pretrain_path = "/lustre/orion/lrn036/world-shared/patrickfan/super-res-torchlight/tutorial/checkpoints/climate-float32/interm_epoch_7.ckpt"
pretrain_path = "/lustre/orion/lrn036/world-shared/patrickfan/super-res-torchlight/tutorial/checkpoints/climate/interm_epoch_9.ckpt"
...
init_hours = np.arange(11, 31 * 24 + 1, 24)

#init_hours = np.arange(0, 2*24+1, 24)
# Set model to evaluation mode once
model.eval()

# Loop through and visualize each forecast initialization
for idx in init_hours:
    print(f"Visualizing at index: {idx}")
