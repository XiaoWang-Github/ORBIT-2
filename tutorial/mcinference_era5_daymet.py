...
from climate_learn.utils.inference import test_on_many_images
...
parser.add_argument("--data_key", type=str, default='DAYMET_3', choices=["INFER", "DAYMET_3", 'DAYMET', 'ERA5_1', 'ERA5_2', 'PRISM'])
parser.add_argument("--image_index", type=int, default=0, help="set -1 to inference all")
# temporally setting
...
if os.path.exists(args.checkpoint_path):
    ...
    #del checkpoint
    print("load pretrained model",args.checkpoint_path," Pretrain path found.",flush=True)
...
cl.utils.mc_dropout.mctest_on_image(
    model,
    dm,
    in_variables = in_vars,
    out_variables = out_vars,
