...
def load_architecture(task, data_module, architecture, default_vars, superres_mag=4,cnn_ratio=4, patch_size=2,embed_dim=256,depth=6,decoder_depth=1,num_heads=4,mlp_ratio=4,drop_path=0.1,drop_rate=0.1,adaptive_patching=False,fixed_length=None, smooth=None, canny=None, canny_add=None, physics=False, edge_percentage=.1, grad_deg=1, data_type="bfloat16"):
    in_vars, out_vars = get_data_variables(data_module)
